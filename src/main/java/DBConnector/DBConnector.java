...
public class DBConnector {
    ...
    // Datenbankparameter - anpassen an eigene Konfiguration
    private static final String DB_URL = "jdbc:mysql://localhost:3306/PersonManagment";
    																  
    private static final String DB_USER = "root";
    private static final String DB_PASSWORD = "KavinGlazzer12!";
     ...
     *
     * @return die einzige Instanz von DatabaseConnection
